...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bc3e9c94971d51ab, []int{0}
}
...
type BatchCommandsRequest_Request struct {
	...
	//	*BatchCommandsRequest_Request_RawUpdate
	//	*BatchCommandsRequest_Request_RawBatchUpdate
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bc3e9c94971d51ab, []int{0, 0}
}
...
type BatchCommandsRequest_Request_RawUpdate struct {
	RawUpdate *kvrpcpb.RawUpdateRequest `protobuf:"bytes,100,opt,name=RawUpdate,oneof"`
}
type BatchCommandsRequest_Request_RawBatchUpdate struct {
	RawBatchUpdate *kvrpcpb.RawBatchUpdateRequest `protobuf:"bytes,101,opt,name=RawBatchUpdate,oneof"`
}
...
func (*BatchCommandsRequest_Request_RawUpdate) isBatchCommandsRequest_Request_Cmd()      {}
func (*BatchCommandsRequest_Request_RawBatchUpdate) isBatchCommandsRequest_Request_Cmd() {}
...
func (m *BatchCommandsRequest_Request) GetRawUpdate() *kvrpcpb.RawUpdateRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_RawUpdate); ok {
		return x.RawUpdate
	}
	return nil
}

func (m *BatchCommandsRequest_Request) GetRawBatchUpdate() *kvrpcpb.RawBatchUpdateRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_RawBatchUpdate); ok {
		return x.RawBatchUpdate
	}
	return nil
}
...
func (*BatchCommandsRequest_Request) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsRequest_Request_OneofMarshaler, _BatchCommandsRequest_Request_OneofUnmarshaler, _BatchCommandsRequest_Request_OneofSizer, []interface{}{
		...
		(*BatchCommandsRequest_Request_RawUpdate)(nil),
		(*BatchCommandsRequest_Request_RawBatchUpdate)(nil),
	}
}
...
func _BatchCommandsRequest_Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsRequest_Request_RawUpdate:
		_ = b.EncodeVarint(100<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawUpdate); err != nil {
			return err
		}
	case *BatchCommandsRequest_Request_RawBatchUpdate:
		_ = b.EncodeVarint(101<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawBatchUpdate); err != nil {
			return err
		}
	case nil:
	default:
...
func _BatchCommandsRequest_Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 22: // cmd.Coprocessor
		...
		return true, err
	case 100: // cmd.RawUpdate
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.RawUpdateRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_RawUpdate{msg}
		return true, err
	case 101: // cmd.RawBatchUpdate
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.RawBatchUpdateRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_RawBatchUpdate{msg}
		return true, err
	default:
		return false, nil
	}
...
func _BatchCommandsRequest_Request_OneofSizer(msg proto.Message) (n int) {
	...
	case *BatchCommandsRequest_Request_Coprocessor:
		...
		n += s
	case *BatchCommandsRequest_Request_RawUpdate:
		s := proto.Size(x.RawUpdate)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case *BatchCommandsRequest_Request_RawBatchUpdate:
		s := proto.Size(x.RawBatchUpdate)
		n += 2 // tag and wire
		n += proto.SizeVarint(uint64(s))
		n += s
	case nil:
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bc3e9c94971d51ab, []int{1}
}
...
type BatchCommandsResponse_Response struct {
	...
	//	*BatchCommandsResponse_Response_RawUpdate
	//	*BatchCommandsResponse_Response_RawBatchUpdate
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bc3e9c94971d51ab, []int{1, 0}
}
...
type BatchCommandsResponse_Response_RawUpdate struct {
	RawUpdate *kvrpcpb.RawUpdateResponse `protobuf:"bytes,100,opt,name=RawUpdate,oneof"`
}
type BatchCommandsResponse_Response_RawBatchUpdate struct {
	RawBatchUpdate *kvrpcpb.RawBatchUpdateResponse `protobuf:"bytes,101,opt,name=RawBatchUpdate,oneof"`
}
...
func (*BatchCommandsResponse_Response_RawUpdate) isBatchCommandsResponse_Response_Cmd()      {}
func (*BatchCommandsResponse_Response_RawBatchUpdate) isBatchCommandsResponse_Response_Cmd() {}
...
func (m *BatchCommandsResponse_Response) GetRawUpdate() *kvrpcpb.RawUpdateResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_RawUpdate); ok {
		return x.RawUpdate
	}
	return nil
}

func (m *BatchCommandsResponse_Response) GetRawBatchUpdate() *kvrpcpb.RawBatchUpdateResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_RawBatchUpdate); ok {
		return x.RawBatchUpdate
	}
	return nil
}
...
func (*BatchCommandsResponse_Response) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsResponse_Response_OneofMarshaler, _BatchCommandsResponse_Response_OneofUnmarshaler, _BatchCommandsResponse_Response_OneofSizer, []interface{}{
		...
		(*BatchCommandsResponse_Response_RawUpdate)(nil),
		(*BatchCommandsResponse_Response_RawBatchUpdate)(nil),
	}
}
...
func _BatchCommandsResponse_Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsResponse_Response_RawUpdate:
		_ = b.EncodeVarint(100<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawUpdate); err != nil {
			return err
		}
	case *BatchCommandsResponse_Response_RawBatchUpdate:
		_ = b.EncodeVarint(101<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.RawBatchUpdate); err != nil {
			return err
		}
...
func _BatchCommandsResponse_Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 100: // cmd.RawUpdate
		...
		msg := new(kvrpcpb.RawUpdateResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_RawUpdate{msg}
		return true, err
	case 101: // cmd.RawBatchUpdate
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.RawBatchUpdateResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_RawBatchUpdate{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bc3e9c94971d51ab, []int{2}
}
...
type TikvClient interface {
	...
	RawUpdate(ctx context.Context, in *kvrpcpb.RawUpdateRequest, opts ...grpc.CallOption) (*kvrpcpb.RawUpdateResponse, error)
	RawBatchUpdate(ctx context.Context, in *kvrpcpb.RawBatchUpdateRequest, opts ...grpc.CallOption) (*kvrpcpb.RawBatchUpdateResponse, error)
...
func (c *tikvClient) RawUpdate(ctx context.Context, in *kvrpcpb.RawUpdateRequest, opts ...grpc.CallOption) (*kvrpcpb.RawUpdateResponse, error) {
	out := new(kvrpcpb.RawUpdateResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/RawUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *tikvClient) RawBatchUpdate(ctx context.Context, in *kvrpcpb.RawBatchUpdateRequest, opts ...grpc.CallOption) (*kvrpcpb.RawBatchUpdateResponse, error) {
	out := new(kvrpcpb.RawBatchUpdateResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/RawBatchUpdate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	RawUpdate(context.Context, *kvrpcpb.RawUpdateRequest) (*kvrpcpb.RawUpdateResponse, error)
	RawBatchUpdate(context.Context, *kvrpcpb.RawBatchUpdateRequest) (*kvrpcpb.RawBatchUpdateResponse, error)
...
func _Tikv_RawUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.RawUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).RawUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/RawUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).RawUpdate(ctx, req.(*kvrpcpb.RawUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _Tikv_RawBatchUpdate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.RawBatchUpdateRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).RawBatchUpdate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/RawBatchUpdate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).RawBatchUpdate(ctx, req.(*kvrpcpb.RawBatchUpdateRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Tikv_RawUpdate_Handler,
		},
		{
			MethodName: "RawBatchUpdate",
			Handler:    _Tikv_RawBatchUpdate_Handler,
		},
		{
...
func (m *BatchCommandsRequest_Request_RawUpdate) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawUpdate != nil {
		dAtA[i] = 0xa2
		i++
		dAtA[i] = 0x6
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawUpdate.Size()))
		n26, err := m.RawUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n26
...
func (m *BatchCommandsRequest_Request_RawBatchUpdate) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawBatchUpdate != nil {
		dAtA[i] = 0xaa
		i++
		dAtA[i] = 0x6
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchUpdate.Size()))
		n27, err := m.RawBatchUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n27
...
func (m *BatchCommandsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.RequestIds) > 0 {
		dAtA29 := make([]byte, len(m.RequestIds)*10)
		var j28 int
		for _, num := range m.RequestIds {
			for num >= 1<<7 {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(j28))
...
func (m *BatchCommandsResponse_Response) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Cmd != nil {
		nn30, err := m.Cmd.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn30
...
func (m *BatchCommandsResponse_Response_Prewrite) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Prewrite != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Prewrite.Size()))
		n33, err := m.Prewrite.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *BatchCommandsResponse_Response_Cleanup) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Cleanup != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Cleanup.Size()))
		n36, err := m.Cleanup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n36
...
func (m *BatchCommandsResponse_Response_BatchGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BatchGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.BatchGet.Size()))
		n37, err := m.BatchGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n37
...
func (m *BatchCommandsResponse_Response_BatchRollback) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BatchRollback != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.BatchRollback.Size()))
		n38, err := m.BatchRollback.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *BatchCommandsResponse_Response_ScanLock) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ScanLock != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ScanLock.Size()))
		n39, err := m.ScanLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *BatchCommandsResponse_Response_ResolveLock) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResolveLock != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ResolveLock.Size()))
		n40, err := m.ResolveLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *BatchCommandsResponse_Response_RawGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawGet.Size()))
		n43, err := m.RawGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *BatchCommandsResponse_Response_RawBatchGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchGet.Size()))
		n44, err := m.RawBatchGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *BatchCommandsResponse_Response_RawPut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawPut != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawPut.Size()))
		n45, err := m.RawPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *BatchCommandsResponse_Response_RawBatchPut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchPut != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchPut.Size()))
		n46, err := m.RawBatchPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *BatchCommandsResponse_Response_RawDelete) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawDelete != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawDelete.Size()))
		n47, err := m.RawDelete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n47
...
func (m *BatchCommandsResponse_Response_RawBatchDelete) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchDelete != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchDelete.Size()))
		n48, err := m.RawBatchDelete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n48
...
func (m *BatchCommandsResponse_Response_RawScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawScan != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawScan.Size()))
		n49, err := m.RawScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *BatchCommandsResponse_Response_RawDeleteRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawDeleteRange != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawDeleteRange.Size()))
		n50, err := m.RawDeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *BatchCommandsResponse_Response_RawBatchScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchScan != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchScan.Size()))
		n51, err := m.RawBatchScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *BatchCommandsResponse_Response_Coprocessor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Coprocessor != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Coprocessor.Size()))
		n52, err := m.Coprocessor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
...
func (m *BatchCommandsResponse_Response_RawUpdate) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawUpdate != nil {
		dAtA[i] = 0xa2
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawUpdate.Size()))
		n53, err := m.RawUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
...
func (m *BatchCommandsResponse_Response_RawBatchUpdate) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.RawBatchUpdate != nil {
		dAtA[i] = 0xaa
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchUpdate.Size()))
		n54, err := m.RawBatchUpdate.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *BatchCommandsRequest_Request_RawUpdate) Size() (n int) {
	var l int
	_ = l
	if m.RawUpdate != nil {
		l = m.RawUpdate.Size()
...
func (m *BatchCommandsRequest_Request_RawBatchUpdate) Size() (n int) {
	var l int
	_ = l
	if m.RawBatchUpdate != nil {
		l = m.RawBatchUpdate.Size()
		n += 2 + l + sovTikvpb(uint64(l))
	}
	return n
}
...
func (m *BatchCommandsResponse_Response_RawUpdate) Size() (n int) {
	var l int
	_ = l
	if m.RawUpdate != nil {
		l = m.RawUpdate.Size()
...
func (m *BatchCommandsResponse_Response_RawBatchUpdate) Size() (n int) {
	var l int
	_ = l
	if m.RawBatchUpdate != nil {
		l = m.RawBatchUpdate.Size()
...
func (m *BatchCommandsRequest_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 100:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &kvrpcpb.RawUpdateRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_RawUpdate{v}
			iNdEx = postIndex
		case 101:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawBatchUpdate", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &kvrpcpb.RawBatchUpdateRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_RawBatchUpdate{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTikvpb(dAtA[iNdEx:])
...
func (m *BatchCommandsResponse_Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 100:
			...
			v := &kvrpcpb.RawUpdateResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_RawUpdate{v}
			iNdEx = postIndex
		case 101:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RawBatchUpdate", wireType)
			...
			v := &kvrpcpb.RawBatchUpdateResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_RawBatchUpdate{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTikvpb(dAtA[iNdEx:])
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_bc3e9c94971d51ab) }

var fileDescriptor_tikvpb_bc3e9c94971d51ab = []byte{
	// 1489 bytes of a gzipped FileDescriptorProto
	,
}
